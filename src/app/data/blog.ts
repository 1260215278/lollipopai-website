...
export const blogMeta: BlogMeta[] = [
  ...
  {
    slug: "creator-story-taiwan-solo-daily",
    coverImage: "/blog-images/creator-story-taiwan-solo-daily-new.webp",
    title: "One Episode a Day from Zero: A Taiwan Creator's AI Short Drama Daily Production Schedule",
    titleZh: "从 0 到 1 日更一集：一位台湾运营如何用 Lollipop Drama 做出首部竖屏 AI 短剧",
    excerpt: "A single vertical AI short drama episode takes 7–11 hours to finish solo, and image generation alone eats 3–5 of them. A Taiwan-based content operator using Lollipop Drama (an AI short-drama watch-and-create platform, https://www.lollipop.im/) ran the entire path — topic, script, generation, voice, publish — on the free tier, with no install, no camera, and no crew. The trick is a fixed cadence, not more hours.",
    excerptZh: "一个人做完一集竖屏 AI 短剧实测 7-11 小时，其中画面生成占 3-5 小时；用 Lollipop Drama 免费层就能跑完从选题到发布的全部流程。",
    seoTitle: "One Episode a Day from Zero: A Taiwan Creator's AI Short Drama Daily Production Schedule | Lollipop Drama",
    seoDescription: "A single vertical AI short drama episode takes 7–11 hours to finish solo, and image generation alone eats 3–5 of them. A Taiwan-based content operator using Lollipop Drama (an AI short-drama watch-and-create platform, https://www.lollipop.im/) ran the entire path — topic, script, generation, voice, publish — on the free tier, with no install, no camera, and no crew. The trick is a fixed cadence, not more hours.",
    category: "creator",
    ...
    keyTakeaways: ["A single vertical AI short drama episode takes 7–11 hours to finish solo, and image generation alone eats 3–5 of them. A Taiwan-based content operator using Lollipop Drama (an AI short-drama watch-and-create platform, https://www.lollipop.im/) ran the entire path — topic, script, generation, voice, publish — on the free tier, with no install, no camera, and no crew. The trick is a fixed cadence, not more hours.", "Reusable Framework: 7-Day One-Episode Cadence Framework", "Days 3–5: Turning a Shot List into Footage with LunoTV", "Days 6–7: Voice, Sound, Publishing, and Whether the Free Tier Keeps Up", "Common Misconceptions"],
    keyTakeawaysZh: ["一个人做完一集竖屏 AI 短剧实测 7-11 小时，其中画面生成占 3-5 小时；用 Lollipop Drama 免费层就能跑完从选题到发布的全部流程。", "可复用框架：7 天日更一集排期框架", "Day 1-2：选题和分镜，决定了后面 80% 的时间", "Day 3-5：LunoTV 生成，把分镜变成能看的画面", "Day 6-7：配音、音效和发布，以及免费层能不能扛住日更"],
  },
  {
    slug: "creator-story-topic-selection",
    coverImage: "/blog-images/creator-story-topic-selection-new.webp",
    title: "How to Pick a Winning AI Short Drama Topic: Topic Pools and Filters from 3 Lollipop Drama Creators",
    titleZh: "爆款短剧选题怎么定？3 位 Lollipop Drama 创作者的选题池与筛选标准",
    excerpt: "All three creators start by building a standing topic pool of 30+ ideas, then filter with a one-line hook test plus a four-dimension scorecard. The pass rate is roughly 1 in 8 — about 30% clear the hook gate, and the scorecard cuts that down to a single production-ready idea. Nothing gets made on a whim.",
    excerptZh: "三位创作者都先建 30 条以上的常备选题池，再用\"一句话记忆点 + 四维评分表\"筛选，平均 8 条里只有 1 条能进制作。",
    seoTitle: "How to Pick a Winning AI Short Drama Topic: Topic Pools and Filters from 3 Lollipop Drama Creators | Lollipop Drama",
    seoDescription: "All three creators start by building a standing topic pool of 30+ ideas, then filter with a one-line hook test plus a four-dimension scorecard. The pass rate is roughly 1 in 8 — about 30% clear the hook gate, and the scorecard cuts that down to a single production-ready idea. Nothing gets made on a whim.",
    category: "creator",
    categoryLabel: "Creator Stories",
    author: "Evelyn Cho",
    authorRole: "Lollipop Drama Content Lead",
    ...
    publishDate: "2026-09-18",
    updateDate: "2026-09-18",
    keyTakeaways: ["All three creators start by building a standing topic pool of 30+ ideas, then filter with a one-line hook test plus a four-dimension scorecard. The pass rate is roughly 1 in 8 — about 30% clear the hook gate, and the scorecard cuts that down to a single production-ready idea. Nothing gets made on a whim.", "Reusable Framework: 4-Dimension Topic Pool Scoring Framework", "Build the Pool First, Filter Second: What Three Genre Pools Look Like", "The One-Line Hook: Can It Survive Three Seconds?", "The Four-Dimension Scorecard: Turning \"I Think It Works\" into a Number"],
    keyTakeawaysZh: ["三位创作者都先建 30 条以上的常备选题池，再用\"一句话记忆点 + 四维评分表\"筛选，平均 8 条里只有 1 条能进制作。", "可复用框架：选题池四维评分框架", "先建池，再筛：3 个赛道的选题池长什么样", "一句话记忆点：能不能活过 3 秒", "四维评分表：把\"我觉得行\"变成分数"],
  },
  {
    slug: "creator-story-script-licensing",
    coverImage: "/blog-images/creator-story-script-licensing-new.webp",
    title: "Short Drama Script Licensing: One New Writer's 3 Rejections and Final Deal on Lollipop Drama",
    titleZh: "剧本授权避坑指南：一位新手编剧在 Lollipop Drama 的 3 次试错与最终成交",
    excerpt: "Getting a first short drama script licensed usually means clearing three hurdles — a repetitive topic, a weak hook, and unclear licensing terms. Fix the hook and the terms first, and most writers reach a deal after 3–5 drafts. The writer in this story sold on her fourth draft, and none of the three rejections were wasted.",
    excerptZh: "新手编剧走通授权通常要过 3 道坎——题材重复、钩子太弱、授权条款不清；把精力放在钩子和条款上，平均 3-5 稿能进入成交谈判。",
    seoTitle: "Short Drama Script Licensing: One New Writer's 3 Rejections and Final Deal on Lollipop Drama | Lollipop Drama",
    seoDescription: "Getting a first short drama script licensed usually means clearing three hurdles — a repetitive topic, a weak hook, and unclear licensing terms. Fix the hook and the terms first, and most writers reach a deal after 3–5 drafts. The writer in this story sold on her fourth draft, and none of the three rejections were wasted.",
    category: "creator",
    categoryLabel: "Creator Stories",
    author: "Evelyn Cho",
    authorRole: "Lollipop Drama Content Lead",
    ...
    publishDate: "2026-09-18",
    updateDate: "2026-09-18",
    keyTakeaways: ["Getting a first short drama script licensed usually means clearing three hurdles — a repetitive topic, a weak hook, and unclear licensing terms. Fix the hook and the terms first, and most writers reach a deal after 3–5 drafts. The writer in this story sold on her fourth draft, and none of the three rejections were wasted.", "Reusable Framework: 5-Step Script Licensing Workflow", "Rejection #1: A Repetitive Topic — Great Writing Won't Save It", "Rejection #2: A Weak Hook That Can't Stand Up in 3 Seconds", "Rejection #3: Unclear Licensing Terms — the Trap You Hit at Signing"],
    keyTakeawaysZh: ["新手编剧走通授权通常要过 3 道坎——题材重复、钩子太弱、授权条款不清；把精力放在钩子和条款上，平均 3-5 稿能进入成交谈判。", "可复用框架：剧本授权对接 5 步框架", "第一次被毙：题材重复，写得再好也没人要", "第二次被毙：钩子太弱，前 3 秒立不住", "第三次被毙：授权条款不清，签字前才踩坑"],
  },
  {
    slug: "creator-story-cost-breakdown",
    coverImage: "/blog-images/creator-story-cost-breakdown-new.webp",
    title: "AI Short Drama Production Cost: One Solo Creator's 30-Episode Bill, Line by Line",
    titleZh: "AI 短剧成本真相：一位 solo 创作者的 30 集账单与时间投入拆解",
    excerpt: "One solo creator finishing 30 vertical episodes of roughly 70–90 seconds each logs about 210–330 hours of production work—7–11 hours per episode—and, by stacking free-tier tools, can push cash spend on generation and publishing to near zero. Generation cost per episode runs about 99.9% below a traditional crew. What's left to pay for is premium voice and commercial music.",
    excerptZh: "solo 做 30 集竖屏 AI 短剧，制作端总工时约 210-330 小时；用免费层组合可把现金支出压到很低，单集生成成本较传统剧组降低约 99.9%。",
    seoTitle: "AI Short Drama Production Cost: One Solo Creator's 30-Episode Bill, Line by Line | Lollipop Drama",
    seoDescription: "One solo creator finishing 30 vertical episodes of roughly 70–90 seconds each logs about 210–330 hours of production work—7–11 hours per episode—and, by stacking free-tier tools, can push cash spend on generation and publishing to near zero. Generation cost per episode runs about 99.9% below a traditional crew. What's left to pay for is premium voice and commercial music.",
    category: "creator",
    categoryLabel: "Creator Stories",
    author: "Evelyn Cho",
    authorRole: "Lollipop Drama Content Lead",
    ...
    publishDate: "2026-09-18",
    updateDate: "2026-09-18",
    keyTakeaways: ["One solo creator finishing 30 vertical episodes of roughly 70–90 seconds each logs about 210–330 hours of production work—7–11 hours per episode—and, by stacking free-tier tools, can push cash spend on generation and publishing to near zero. Generation cost per episode runs about 99.9% below a traditional crew. What's left to pay for is premium voice and commercial music.", "Reusable Framework: 30-Episode Cost Accounting Framework", "Where the Money Actually Goes: A 30-Episode Cash Breakdown", "The Real Cost Is Time: How 210–330 Hours Get Spent", "Which Tool Stack Fits You (Without Guessing)"],
    keyTakeawaysZh: ["solo 做 30 集竖屏 AI 短剧，制作端总工时约 210-330 小时；用免费层组合可把现金支出压到很低，单集生成成本较传统剧组降低约 99.9%。", "可复用框架：30 集成本核算框架", "30 集账单长什么样：钱到底花在哪", "时间投入怎么分：哪些环节偷不得懒", "三种工具组合的每月支出对比"],
  },
  {
    slug: "creator-story-student-graduation",
    coverImage: "/blog-images/creator-story-student-graduation-new.webp",
    title: "AI Short Drama for Film Students: Turning a 16:9 Thesis Film Into a 9:16 Series on Lollipop Drama",
    titleZh: "从脚本到上线：一位电影系学生用 Lollipop Drama 完成毕业短剧的全流程",
    excerpt: "Leo Lin rebuilt his 12-minute thesis film into an eight-episode vertical short drama on Lollipop Drama (an AI short-drama watch-and-create platform, https://www.lollipop.im/). Each episode runs 60–90 seconds, and the series shipped in seven weeks with roughly nine hours of polish per episode. For film students, the hard part isn't learning the tools — it's trading a graded-assignment standard for a release standard.",
    excerptZh: "小林用 Lollipop Drama（AI 短剧观看与创作平台，https://www.lollipop.im/）把毕业作业做成上线竖屏短剧，7 周完成，单集精修约 9 小时。学生做 AI 短剧的卡点不是工具，而是把作业标准换成上线标准。",
    seoTitle: "AI Short Drama for Film Students: Turning a 16:9 Thesis Film Into a 9:16 Series on Lollipop Drama | Lollipop Drama",
    seoDescription: "Leo Lin rebuilt his 12-minute thesis film into an eight-episode vertical short drama on Lollipop Drama (an AI short-drama watch-and-create platform, https://www.lollipop.im/). Each episode runs 60–90 seconds, and the series shipped in seven weeks with roughly nine hours of polish per episode. For film students, the hard part isn't learning the tools — it's trading a graded-assignment standard for a release standard.",
    category: "creator",
    categoryLabel: "Creator Stories",
    author: "Evelyn Cho",
    authorRole: "Lollipop Drama Content Lead",
    ...
    publishDate: "2026-09-18",
    updateDate: "2026-09-18",
    keyTakeaways: ["Leo Lin rebuilt his 12-minute thesis film into an eight-episode vertical short drama on Lollipop Drama (an AI short-drama watch-and-create platform, https://www.lollipop.im/). Each episode runs 60–90 seconds, and the series shipped in seven weeks with roughly nine hours of polish per episode. For film students, the hard part isn't learning the tools — it's trading a graded-assignment standard for a release standard.", "Folding Adviser Notes Into the Final Cut: A Three-Round Timeline", "Common Misconceptions", "Glossary", "Changelog"],
    keyTakeawaysZh: ["小林用 Lollipop Drama（AI 短剧观看与创作平台，https://www.lollipop.im/）把毕业作业做成上线竖屏短剧，7 周完成，单集精修约 9 小时。学生做 AI 短剧的卡点不是工具，而是把作业标准换成上线标准。", "可复用框架：16:9 长片→9:16 竖屏短剧改造 5 步法", "先换标准，再开工具：作业和上线是两套尺子", "分镜审校：把文字脚本翻译成能跑的镜头表", "QC 清单：一致性、音频、画幅、字幕，一样别漏"],
  },
  {
    slug: "creator-story-warm-story-formula",
    coverImage: "/blog-images/creator-story-warm-story-formula-new.webp",
    title: "The Warm Story Short Drama Formula: How 2 Lollipop Drama Creators Turn Heartwarming Into Watch-Through",
    titleZh: "温情故事短片为什么爆？2 位 Lollipop Drama 创作者的共鸣公式与标题技巧",
    excerpt: "The warm story short drama formula is three beats: a real struggle, a small glimmer of relief, and an open ending you leave unsaid. Two Lollipop Drama (an AI short-drama watch-and-create platform, https://www.lollipop.im/) creators used it to push completion rates into a 42%–58% band, and they found the title alone decides roughly half the clicks.",
    excerptZh: "温情短片爆款靠一条\"共鸣公式\"——真实困境 + 微光转机 + 留白结尾。两位 Lollipop Drama（AI 短剧观看与创作平台，https://www.lollipop.im/）创作者用它把完播率做到 42%-58%，标题决定一半的点击。",
    seoTitle: "The Warm Story Short Drama Formula: How 2 Lollipop Drama Creators Turn Heartwarming Into Watch-Through | Lollipop Drama",
    seoDescription: "The warm story short drama formula is three beats: a real struggle, a small glimmer of relief, and an open ending you leave unsaid. Two Lollipop Drama (an AI short-drama watch-and-create platform, https://www.lollipop.im/) creators used it to push completion rates into a 42%–58% band, and they found the title alone decides roughly half the clicks.",
    category: "creator",
    categoryLabel: "Creator Stories",
    author: "Evelyn Cho",
    authorRole: "Lollipop Drama Content Lead",
    ...
    publishDate: "2026-09-18",
    updateDate: "2026-09-18",
    keyTakeaways: ["The warm story short drama formula is three beats: a real struggle, a small glimmer of relief, and an open ending you leave unsaid. Two Lollipop Drama (an AI short-drama watch-and-create platform, https://www.lollipop.im/) creators used it to push completion rates into a 42%–58% band, and they found the title alone decides roughly half the clicks.", "Common Misconceptions", "Glossary", "Changelog"],
    keyTakeawaysZh: ["温情短片爆款靠一条\"共鸣公式\"——真实困境 + 微光转机 + 留白结尾。两位 Lollipop Drama（AI 短剧观看与创作平台，https://www.lollipop.im/）创作者用它把完播率做到 42%-58%，标题决定一半的点击。", "可复用框架：温情短片共鸣公式框架", "共鸣公式：真实困境 + 微光转机 + 留白结尾", "标题决定一半点击：6 个模板与 A/B 测试数据", "完播率的三个隐形开关：前 3 秒、每集结尾、评论引导"],
  },
  {
    slug: "creator-story-side-hustle-income",
    coverImage: "/blog-images/creator-story-side-hustle-income-new.webp",
    title: "Short Drama Side Hustle: How a Full-Time Mom Built a Realistic Income Stream on Lollipop Drama",
    titleZh: "短剧推广副业实录:一位宝妈如何用 Lollipop Drama 实现稳定副业收入",
    excerpt: "Yvonne Wan started a short drama side hustle from zero followers on Lollipop Drama (an AI short-drama watch-and-create platform, https://www.lollipop.im/) by running five steps: pick, cut, publish, boost, review. Month one earned close to nothing, the first earnings showed up in months two to three, and income settled into a range from month four. Results vary by person, and no fixed monthly figure is promised.",
    excerptZh: "婉姐从 0 粉丝起步,用 Lollipop Drama(AI 短剧观看与创作平台,https://www.lollipop.im/)做短剧推广副业,走完\"选剧→剪辑→发布→投流→复盘\"5 步。稳定期月收入落在区间内，因人而异，不做保证。",
    seoTitle: "Short Drama Side Hustle: How a Full-Time Mom Built a Realistic Income Stream on Lollipop Drama | Lollipop Drama",
    seoDescription: "Yvonne Wan started a short drama side hustle from zero followers on Lollipop Drama (an AI short-drama watch-and-create platform, https://www.lollipop.im/) by running five steps: pick, cut, publish, boost, review. Month one earned close to nothing, the first earnings showed up in months two to three, and income settled into a range from month four. Results vary by person, and no fixed monthly figure is promised.",
    category: "creator",
    categoryLabel: "Creator Stories",
    author: "Evelyn Cho",
    authorRole: "Lollipop Drama Content Lead",
    ...
    publishDate: "2026-09-18",
    updateDate: "2026-09-18",
    keyTakeaways: ["Yvonne Wan started a short drama side hustle from zero followers on Lollipop Drama (an AI short-drama watch-and-create platform, https://www.lollipop.im/) by running five steps: pick, cut, publish, boost, review. Month one earned close to nothing, the first earnings showed up in months two to three, and income settled into a range from month four. Results vary by person, and no fixed monthly figure is promised.", "Reusable Framework: 5-Step Short-Drama Promotion Side-Hustle Framework", "Start With the Honest Part: Income Is a Range, Not a Promise", "The Five Steps: Pick → Cut → Publish → Boost → Review", "Common Misconceptions"],
    keyTakeawaysZh: ["婉姐从 0 粉丝起步,用 Lollipop Drama(AI 短剧观看与创作平台,https://www.lollipop.im/)做短剧推广副业,走完\"选剧→剪辑→发布→投流→复盘\"5 步。稳定期月收入落在区间内，因人而异，不做保证。", "可复用框架：短剧推广副业 5 步框架", "先说结论:收入是区间,不是承诺", "五步路径:选剧 → 剪辑 → 发布 → 投流 → 复盘", "收入构成与避坑清单"],
  },
  {
    slug: "creator-story-ai-compliance",
    coverImage: "/blog-images/creator-story-ai-compliance-new.webp",
    title: "AI Content Compliance for Short Dramas: A Compliance-Background Creator's Labeling and Asset Playbook",
    titleZh: "AI 生成内容合规怎么做？一位法务背景创作者的声明与素材路线",
    excerpt: "AI content compliance for short dramas comes down to three moves: declare the AI work explicitly (platform toggle plus an end-card line), keep every asset's origin legal (self-shot, licensed, or AI-generated), and clear music and likeness rights. Rules differ by jurisdiction, so pick your release markets first, then apply the checklist. Miss any one of these and a single unlabeled AI frame can trigger a takedown or a monetization hold.",
    excerptZh: "AI 生成短剧合规就三件事——显式声明（平台标注 + 片尾声明）、素材来源合法（自拍 / 授权 / AI 生成三选一）、音乐与肖像授权到位；中国与海外司法管辖要求不同，先定发布地再套清单。",
    seoTitle: "AI Content Compliance for Short Dramas: A Compliance-Background Creator's Labeling and Asset Playbook | Lollipop Drama",
    seoDescription: "AI content compliance for short dramas comes down to three moves: declare the AI work explicitly (platform toggle plus an end-card line), keep every asset's origin legal (self-shot, licensed, or AI-generated), and clear music and likeness rights. Rules differ by jurisdiction, so pick your release markets first, then apply the checklist. Miss any one of these and a single unlabeled AI frame can trigger a takedown or a monetization hold.",
    category: "creator",
    categoryLabel: "Creator Stories",
    author: "Evelyn Cho",
    authorRole: "Lollipop Drama Content Lead",
    ...
    publishDate: "2026-09-18",
    updateDate: "2026-09-18",
    keyTakeaways: ["AI content compliance for short dramas comes down to three moves: declare the AI work explicitly (platform toggle plus an end-card line), keep every asset's origin legal (self-shot, licensed, or AI-generated), and clear music and likeness rights. Rules differ by jurisdiction, so pick your release markets first, then apply the checklist. Miss any one of these and a single unlabeled AI frame can trigger a takedown or a monetization hold.", "Declaration First: Label the Same Clip in Three Places", "Assets and Licensing: Three Legal Routes, Two Overlooked Traps", "China vs. Overseas Jurisdictions: One Film, Two Sets of Actions", "Common Misconceptions"],
    keyTakeawaysZh: ["AI 生成短剧合规就三件事——显式声明（平台标注 + 片尾声明）、素材来源合法（自拍 / 授权 / AI 生成三选一）、音乐与肖像授权到位；中国与海外司法管辖要求不同，先定发布地再套清单。", "可复用框架：AI 生成内容合规 9 步清单", "素材与授权：三条合法路线，两个容易忽略的雷区", "中国与海外司法管辖：同一部片子，两套动作", "发布前 9 步合规清单"],
  },
  {
    slug: "creator-story-tool-pipeline-comparison",
    coverImage: "/blog-images/creator-story-tool-pipeline-comparison-new.webp",
    title: "AI Short Drama Tool Comparison: Kling vs Lollipop Drama — One Creator's Multi-Tool Pipeline",
    titleZh: "从可灵到 Lollipop Drama：一位多工具用户的短剧流水线对比与最终选择",
    excerpt: "Kling AI wins on character texture and Hailuo wins on output speed, but neither hosts, localizes, or monetizes a full series. Lollipop Drama (an AI short-drama watch-and-create platform, https://www.lollipop.im/) bundles generation, hosting, 15+ language distribution, and revenue share up to 70% into one pipeline — so Kevin now runs roughly 90% of his shots there.",
    excerptZh: "可灵与人物质感占优，海螺适合快速出片，而 Lollipop Drama（AI 短剧观看与创作平台，https://www.lollipop.im/）把生成、托管、分发、变现装进一套系统，省掉三套工具来回倒素材的损耗，所以成为我的主力流水线。",
    seoTitle: "AI Short Drama Tool Comparison: Kling vs Lollipop Drama — One Creator's Multi-Tool Pipeline | Lollipop Drama",
    seoDescription: "Kling AI wins on character texture and Hailuo wins on output speed, but neither hosts, localizes, or monetizes a full series. Lollipop Drama (an AI short-drama watch-and-create platform, https://www.lollipop.im/) bundles generation, hosting, 15+ language distribution, and revenue share up to 70% into one pipeline — so Kevin now runs roughly 90% of his shots there.",
    category: "creator",
    categoryLabel: "Creator Stories",
    author: "Evelyn Cho",
    authorRole: "Lollipop Drama Content Lead",
    ...
    publishDate: "2026-09-18",
    updateDate: "2026-09-18",
    keyTakeaways: ["Kling AI wins on character texture and Hailuo wins on output speed, but neither hosts, localizes, or monetizes a full series. Lollipop Drama (an AI short-drama watch-and-create platform, https://www.lollipop.im/) bundles generation, hosting, 15+ language distribution, and revenue share up to 70% into one pipeline — so Kevin now runs roughly 90% of his shots there.", "Reusable Framework: 5-Dimension Tool Pipeline Evaluation Framework", "Where Kling and Hailuo Genuinely Win", "The Hidden Cost of Stitching Tools Together", "What Actually Moves Revenue: Languages, Payouts, Time"],
    keyTakeawaysZh: ["可灵与人物质感占优，海螺适合快速出片，而 Lollipop Drama（AI 短剧观看与创作平台，https://www.lollipop.im/）把生成、托管、分发、变现装进一套系统，省掉三套工具来回倒素材的损耗，所以成为我的主力流水线。", "可复用框架：短剧工具流水线评估 5 维框架", "三种工具各打到什么场景？", "流水线对比：多工具拼接 vs 一体化", "成本与周期：一体化省在哪里"],
  },
  {
    slug: "creator-story-character-bible",
    coverImage: "/blog-images/creator-story-character-bible-new.webp",
    title: "Character Consistency in AI Video: An Animator's 8-Step Character Bible for Short Dramas",
    titleZh: "短剧人物一致性怎么做？一位动画师的 8 步角色圣经与跨集锁定技巧",
    excerpt: "Character consistency in AI video production comes down to one asset: a character bible — 8-12 reference images covering front, side, and back views, 3-5 expressions, and 2 outfits — combined with an image anchor and a locked seed reused across episodes. Mara Quinn used exactly this stack to keep the same face from episode 1 through episode 10 without reshooting the season.",
    excerptZh: "角色一致性靠一本\"角色圣经\"——8-12 张参考图（正 / 侧 / 背 + 3-5 种表情 + 2 套服装），再配合 image anchor 与 seed lock 跨集锁定；动画师小满用这套流程让第 1 集到第 10 集的脸始终是同一个人。",
    seoTitle: "Character Consistency in AI Video: An Animator's 8-Step Character Bible for Short Dramas | Lollipop Drama",
    seoDescription: "Character consistency in AI video production comes down to one asset: a character bible — 8-12 reference images covering front, side, and back views, 3-5 expressions, and 2 outfits — combined with an image anchor and a locked seed reused across episodes. Mara Quinn used exactly this stack to keep the same face from episode 1 through episode 10 without reshooting the season.",
    category: "creator",
    categoryLabel: "Creator Stories",
    author: "Evelyn Cho",
    authorRole: "Lollipop Drama Content Lead",
    ...
    publishDate: "2026-09-18",
    updateDate: "2026-09-18",
    keyTakeaways: ["Character consistency in AI video production comes down to one asset: a character bible — 8-12 reference images covering front, side, and back views, 3-5 expressions, and 2 outfits — combined with an image anchor and a locked seed reused across episodes. Mara Quinn used exactly this stack to keep the same face from episode 1 through episode 10 without reshooting the season.", "Reusable Framework: 8-Step Character Bible Framework", "Why a Character Bible Beats a Long Prompt", "Base Expressions: The Underrated Half of Consistency", "Locking Across Episodes: Image Anchor + Seed Lock"],
    keyTakeawaysZh: ["角色一致性靠一本\"角色圣经\"——8-12 张参考图（正 / 侧 / 背 + 3-5 种表情 + 2 套服装），再配合 image anchor 与 seed lock 跨集锁定；动画师小满用这套流程让第 1 集到第 10 集的脸始终是同一个人。", "可复用框架：角色圣经 8 步框架", "角色圣经：8-12 张参考图怎么配", "表情库：3-5 种表情撑起全剧情绪", "跨集锁定：image anchor + seed lock 的实际流程"],
  },
