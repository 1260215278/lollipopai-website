...
const enMessages = {
  ...
  hero: {
    ...
    aiSummary: "Lollipop Drama is an AI-powered short drama creation and streaming platform. Create professional videos from text using built-in AI tools, earn 80% revenue share, and reach 1M+ users across 100+ countries worldwide.",
  ...
  aiFeatures: {
    ...
    title: "Create with AI — Powered by Lollipop Drama",
    description: "Lollipop Drama brings revolutionary AI creation tools to every storyteller — generate images, swap faces, create videos from text, and publish your short dramas directly to a global audience of 1M+ users.",
    features: [
      {
  ...
  creator: {
    ...
    description: "Lollipop Drama offers the highest creator revenue share in the short drama industry — 80%, with powerful built-in AI creation tools. We provide comprehensive creative support so great content receives the rewards it deserves.",
    benefits: [
  ...
  about: {
    heroTitle: "About",
    heroHighlight: "Lollipop Drama",
    heroSubtitle: "AI-Powered Short Drama Platform — Opening a New Era of Global Entertainment",
    companyTitle: "Company Overview",
    companySub: "A global AI-powered short drama platform empowering creators and audiences",
    companyParagraphs: [
      ...
      "Creators enjoy an industry-leading 80% revenue share, with built-in AI tools for text-to-video, image generation, face swap, and style transfer. The fund's strategic goal is to systematically promote K-Contents globally, with a strong focus on co-productions with international production partners.",
    ...
    companyStats: [
      ...
      { num: "100K+", label: "Quality Creators (as of 2026)" },
      { num: "100+", label: "Countries (as of 2026)" },
    ],
...
const translations: Record<Locale, TranslationMessages> = {
  ...
  "zh-CN": {
    ...
    taglineLine2: "消费即激励 · 下一代海外内容生态平台",
      ...
      aiSummary: "Lollipop Drama是AI驱动的短剧创作与消费平台。内置AI文生视频工具，创作者享受80%收益分成，覆盖全球100+国家和100万+用户。",
    ...
    about: {
      heroTitle: "关于",
      heroHighlight: "Lollipop Drama",
      heroSubtitle: "AI驱动的短剧平台 — 开启全球娱乐新时代",
      companyTitle: "公司概览",
      companySub: "连接创作者与观众的全球化AI短剧平台",
      companyParagraphs: [
        "Lollipop Drama 由香港 Nyx Entertainment Group 与韩国文化投资基金共同打造。平台将内置AI视频生成工具与精品短剧流媒体库相结合，让人人都能创作并变现内容。",
        "创作者享受行业领先的80%收益分成，平台内置AI文生视频、图片生成、换脸和风格迁移等创作工具。基金战略目标是通过联合出品与国际合作系统性推动 K-Contents 走向全球。",
        "平台正积极拓展中国、日本、北美、欧洲、东南亚及中东等多元市场，并加速本地化运营布局。",
      ],
      companyStats: [
        { num: "100万+", label: "全球用户（截至2026年）" },
        { num: "10万+", label: "优质创作者（截至2026年）" },
        { num: "100+", label: "国家（截至2026年）" },
      ],
      teamTitle: "核心团队",
  ...
  "zh-TW": {
    ...
    taglineLine2: "消費即激勵 · 下一代海外內容生態平台",
      ...
      aiSummary: "Lollipop Drama是AI驅動的短劇創作與消費平台。內建AI文生影片工具，創作者享受80%收益分成，覆蓋全球100+國家和100萬+用戶。",
    ...
    about: {
      heroTitle: "關於",
      heroHighlight: "Lollipop Drama",
      heroSubtitle: "AI驅動的短劇平台 — 開啟全球娛樂新時代",
      companyTitle: "公司概覽",
      companySub: "連結創作者與觀眾的全球化AI短劇平台",
      companyParagraphs: [
        "Lollipop Drama 由香港 Nyx Entertainment Group 與韓國文化投資基金共同打造。平台將內建AI影片生成工具與精品短劇串流庫相結合，讓人人都能創作並變現內容。",
        "創作者享受行業領先的80%收益分成，平台內建AI文生影片、圖像生成、換臉和風格遷移等創作工具。基金戰略目標是透過聯合出品與國際合作系統性推動 K-Contents 走向全球。",
        "平台正積極拓展中國、日本、北美、歐洲、東南亞及中東等多元市場，並加速本地化營運布局。",
      ],
      companyStats: [
        { num: "100萬+", label: "全球用戶（截至2026年）" },
        { num: "10萬+", label: "優質創作者（截至2026年）" },
        { num: "100+", label: "國家（截至2026年）" },
      ],
      teamTitle: "核心團隊",
  ...
  pt: {
    ...
    taglineLine2: "O ecossistema global de conteúdo da próxima geração.",
      ...
      aiSummary: "Lollipop Drama e uma plataforma de criacao e streaming de dramas curtos com IA. Crie videos profissionais a partir de texto usando ferramentas de IA integradas, ganhe 80% da receita e alcance mais de 1 milhao de usuarios em 100+ paises.",
    ...
    about: {
      heroTitle: "Sobre",
      heroHighlight: "Lollipop Drama",
      heroSubtitle: "Plataforma de Dramas Curtos com IA — Abrindo uma Nova Era de Entretenimento Global",
      companyTitle: "Visão Geral da Empresa",
      companySub: "Uma plataforma global de dramas curtos com IA para criadores e audiências",
      companyParagraphs: [
        "A Lollipop Drama é uma joint venture entre a Nyx Entertainment Group, de Hong Kong, e o Fundo Coreano de Investimento Cultural. A plataforma combina ferramentas integradas de geracao de video por IA com uma biblioteca de dramas curtos premium, permitindo que qualquer pessoa crie e monetize conteudo.",
        "Os criadores desfrutam de uma lideranca na industria de 80% de participacao na receita, com ferramentas integradas de IA para texto-para-video, geracao de imagens, troca de rosto e transferencia de estilo. O objetivo estrategico do fundo e promover K-Contents globalmente por meio de coproducoes e parcerias internacionais.",
        "A plataforma esta se expandindo pela China, Japao, America do Norte, Europa, Sudeste Asiatico e Oriente Medio, acelerando estrategias localizadas de crescimento.",
      ],
      companyStats: [
        { num: "1M+", label: "Usuários Globais (até 2026)" },
        { num: "100K+", label: "Criadores de Qualidade (até 2026)" },
        { num: "100+", label: "Países (até 2026)" },
      ],
  ...
  es: {
    ...
    taglineLine2: "El ecosistema global de contenido de nueva generación.",
      ...
      aiSummary: "Lollipop Drama es una plataforma de creación y streaming de dramas cortos con IA. Crea videos profesionales desde texto usando herramientas de IA integradas, gana 80% de los ingresos y llega a más de 1M de usuarios en 100+ países.",
    ...
    about: {
      heroTitle: "Acerca de",
      heroHighlight: "Lollipop Drama",
      heroSubtitle: "Plataforma de Dramas Cortos con IA — Abriendo una Nueva Era de Entretenimiento Global",
      companyTitle: "Visión general de la empresa",
      companySub: "Una plataforma global de drama corto con IA que empodera a creadores y audiencias",
      companyParagraphs: [
        "Lollipop Drama es una empresa conjunta entre Nyx Entertainment Group, con sede en Hong Kong, y el Fondo Coreano de Inversión Cultural. La plataforma combina herramientas integradas de generación de video por IA con una biblioteca de dramas cortos premium, permitiendo a cualquiera crear y monetizar contenido.",
        "Los creadores disfrutan de un 80% de participación en los ingresos, líder en la industria, con herramientas integradas de IA para texto a video, generación de imágenes, intercambio de rostros y transferencia de estilo. El objetivo estratégico del fondo es promover sistemáticamente los K-Contents a nivel global, con un fuerte enfoque en coproducciones con socios internacionales.",
      ...
      companyStats: [
        { num: "1M+", label: "Usuarios globales (hasta 2026)" },
        { num: "100K+", label: "Creadores de calidad (hasta 2026)" },
        { num: "100+", label: "Países (hasta 2026)" },
      ],
  ...
  ar: {
    ...
    taglineLine2: "النظام البيئي العالمي للمحتوى من الجيل التالي.",
      ...
      aiSummary: "Lollipop Drama هي منصة إنشاء وبث دراما قصيرة مدعومة بالذكاء الاصطناعي. أنشئ مقاطع فيديو احترافية من النص باستخدام أدوات الذكاء الاصطناعي المدمجة، واحصل على 80% من الإيرادات، ووصل إلى أكثر من مليون مستخدم في 100+ دولة.",
    ...
    about: {
      heroTitle: "عن",
      heroHighlight: "Lollipop Drama",
      heroSubtitle: "منصة دراما قصيرة بالذكاء الاصطناعي — افتتاح عصر جديد للترفيه العالمي",
      companyTitle: "نظرة عامة على الشركة",
      companySub: "منصة عالمية للدراما القصيرة بالذكاء الاصطناعي تمكّن المبدعين والجمهور",
      companyParagraphs: [
        "Lollipop Drama مشروع مشترك بين Nyx Entertainment Group في هونغ كونغ وصندوق الاستثمار الثقافي الكوري. تجمع المنصة بين أدوات مدمجة لتوليد الفيديو بالذكاء الاصطناعي ومكتبة دراما قصيرة مميزة، مما يتيح للجميع إنشاء المحتوى وتحقيق الدخل منه.",
        "يستمتع المبدعون بنسبة 80% من الإيرادات، وهي الأعلى في الصناعة، مع أدوات مدمجة للذكاء الاصطناعي تشمل تحويل النص إلى فيديو وتوليد الصور وتبديل الوجوه ونقل الأسلوب. الهدف الاستراتيجي للصندوق هو الترويج المنهجي للمحتوى الكوري عالميًا، مع تركيز قوي على الإنتاج المشترك مع شركاء دوليين.",
      ...
      companyStats: [
        { num: "1M+", label: "مستخدمون عالميون (حتى 2026)" },
        { num: "100K+", label: "مبدعو جودة (حتى 2026)" },
        { num: "100+", label: "دول (حتى 2026)" },
      ],
