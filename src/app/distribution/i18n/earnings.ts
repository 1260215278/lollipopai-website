...
export const earnings: Record<Locale, EarningsMessages> = {
  ...
  en: {
    ...
    tabDrama: "Drama Earnings",
    tabVip: "Membership Earnings",
  ...
  pt: {
    ...
    tabDrama: "Receita de dramas",
    tabVip: "Receita de assinatura",
  ...
  es: {
    ...
    tabDrama: "Ingresos por dramas",
    tabVip: "Ingresos por membresía",
  ...
  ar: {
    ...
    tabDrama: "أرباح الدراما",
    tabVip: "أرباح العضوية",
