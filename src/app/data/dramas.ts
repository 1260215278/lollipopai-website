...
export const dramas: DramaData[] = [
  ...
  },
  {
    ...
    views: "41M",
    rating: "9.4",
    seoTitle: "Why Jump Off the Building — Watch | Lollipop Drama",
    seoDescription:
      "Watch Why Jump Off the Building full episodes on Lollipop Drama. A mystery thriller uncovering the truth behind a shocking incident. 90 episodes, 41M views.",
    synopsis:
      "When a prominent businessman appears to jump from his office window, the police close the case as suicide. But his daughter, a former forensic psychologist, refuses to accept the official story. Her investigation leads her into a dangerous underworld of corporate espionage, political corruption, and long-buried family secrets. Each episode peels back another layer of the conspiracy, revealing that nothing — and no one — is as it seems. The series masterfully weaves together multiple timelines and perspectives, keeping viewers guessing until the final episode. With 90 episodes and 41 million views, Why Jump Off the Building is one of the most discussed mystery thrillers on Lollipop Drama.",
  ...
  },
  {
    ...
    views: "18M",
    rating: "9.2",
    seoTitle: "Crimson Dynasty — Watch Full Episodes | Lollipop Drama",
    seoDescription:
      "Watch Crimson Dynasty full episodes on Lollipop Drama. A historical drama about palace intrigue and royal power struggles in an ancient empire. 45 episodes.",
    synopsis:
  ...
  },
  {
    ...
    views: "15M",
    rating: "8.9",
    seoTitle: "Whispered Love — Watch Full Episodes | Lollipop Drama",
    seoDescription:
      "Watch Whispered Love full episodes on Lollipop Drama. A tender romance drama about two people finding love through whispered conversations. 55 episodes.",
    synopsis:
  ...
  },
  {
    ...
    views: "10M",
    rating: "9.4",
    seoTitle: "The Forgotten — Watch Full Episodes | Lollipop Drama",
    seoDescription:
      "Watch The Forgotten full episodes on Lollipop Drama. A suspense mystery about a woman who wakes up with no memory in a town where no one remembers her. 40 episodes.",
    synopsis:
  ...
  },
  {
    ...
    views: "14M",
    rating: "9.1",
    seoTitle: "Iron Will — Watch Full Episodes | Lollipop Drama",
    seoDescription:
      "Watch Iron Will full episodes on Lollipop Drama. An action-packed martial arts drama about a fighter's journey from underground rings to championship. 48 episodes.",
    synopsis:
  ...
  },
  {
    ...
    views: "16M",
    rating: "9.3",
    seoTitle: "Cloud Atlas — Watch Full Episodes | Lollipop Drama",
    seoDescription:
      "Watch Cloud Atlas full episodes on Lollipop Drama. A fantasy adventure about explorers journeying through floating islands above the clouds. 60 episodes.",
    synopsis:
