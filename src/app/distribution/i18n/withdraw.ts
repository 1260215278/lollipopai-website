...
export const withdraw: Record<Locale, WithdrawMessages> = {
  ...
  es: {
    ...
    subtitle: "Envíe solicitudes de liquidación y consulte los registros",
    policyTitle: "Política de liquidación",
    policyDesc: "Los pagos se emiten el día 15 de cada mes. Las solicitudes se revisan en 1-3 días hábiles y se pagan a la cuenta de cobro predeterminada tras la aprobación.",
    payoutDate: "Las liquidaciones se pagan a la cuenta de cobro predeterminada",
    totalSettled: "Total liquidado",
    settledCount: "Órdenes liquidadas",
    pendingTotal: "Importe liquidable",
    applySettlement: "Enviar solicitud",
    resubmitSettlement: "Reenviar solicitud",
    alreadyApplied: "✓ Enviado este mes",
    blockNoAccount: "Añada primero una cuenta de cobro",
    blockAlreadyApplied: "Ya se envió este mes",
    blockNoEarnings: "No hay ingresos liquidables de meses naturales completos hasta el mes pasado",
    chartTitle: "Resumen de liquidación",
    chartSubtitle: "Tendencias mensuales de liquidación por drama",
    chartByTime: "Por tiempo",
    chartByDrama: "Por drama",
    chartAmount: "Importe de liquidación",
    chartCumulative: "Liquidado acumulado",
    compareCourses: "Comparar dramas:",
    selectCourse: "Seleccionar",
    emptyChart: "Sin datos de gráfico",
    recordsTitle: "Registros de liquidación",
    statusFilter: "Estado",
    statusAll: "Todos",
    scopeAll: "Todos los tipos",
    searchPlaceholder: "Buscar n.º de pedido / período",
    colOrderNo: "N.º de pedido",
    colPeriod: "Período",
    colType: "Tipo",
    colRatio: "Proporción",
    colTypeRatio: "Tipo / Proporción",
    colAccountNo: "N.º de cuenta",
    colCreator: "Importe",
    colDate: "Fecha de liquidación",
    colStatus: "Estado",
    colAction: "Acción",
    colOrders: "Pedidos",
    typeFull: "Distribución total",
    typeAccount: "Página de la cuenta",
    statusApplied: "Pendiente de revisión",
    statusApproved: "Pendiente de pago",
    statusPaid: "Pagado",
    statusRejected: "Rechazado/Fallido",
    groupApplied: "Solicitado",
    groupSettled: "Liquidado",
    groupFailed: "Fallido",
    detail: "Detalle",
    detailTitle: "Detalle de liquidación",
    detailOrderNo: "N.º de solicitud",
    detailApplyTime: "Solicitado el",
    detailPeriod: "Período",
    detailAccount: "Cuenta de cobro",
    detailAmount: "Importe solicitado",
    detailStatus: "Estado de la solicitud",
    detailGross: "Bruto",
    detailPlatform: "Participación de la plataforma",
    detailVoucher: "Comprobante de pago",
    itemCourse: "ID del curso",
    itemGross: "Bruto",
    itemCreator: "Neto del productor",
    applyConfirmTitle: "¿Enviar solicitud de liquidación?",
    applyConfirmDesc: "Esto generará órdenes de liquidación para todos los meses naturales completos no liquidados hasta el final del mes pasado.",
    applyConfirmPeriod: "Período",
    applyConfirmAmount: "Importe liquidable",
    applyConfirmAccount: "Cuenta de cobro",
    applyConfirmTip: "La revisión tarda 1-3 días hábiles, con pago antes del día 15.",
    cancel: "Cancelar",
    confirmApply: "Enviar",
    rejectedReason: "Motivo del fallo",
    emptyTitle: "No hay registros de liquidación",
    emptyDesc: "Aún no hay solicitudes de liquidación que mostrar.",
    applySuccess: "Solicitud de liquidación enviada",
  },
  ar: {
    title: "إدارة التسوية",
    subtitle: "قدّم طلبات التسوية واعرض السجلات",
    policyTitle: "سياسة التسوية",
    policyDesc: "تُصرف الدفعات في اليوم 15 من كل شهر. تُراجع الطلبات خلال 1-3 أيام عمل وتُدفع إلى حساب التحصيل الافتراضي بعد الموافقة.",
    payoutDate: "تُدفع التسويات إلى حساب التحصيل الافتراضي",
    totalSettled: "إجمالي المُسوّى",
    settledCount: "الطلبات المُسوّاة",
    pendingTotal: "المبلغ القابل للتسوية",
    applySettlement: "تقديم الطلب",
    resubmitSettlement: "إعادة تقديم الطلب",
    alreadyApplied: "✓ قُدِّم هذا الشهر",
    blockNoAccount: "أضف حساب تحصيل أولًا",
    blockAlreadyApplied: "تم التقديم هذا الشهر بالفعل",
    blockNoEarnings: "لا توجد أرباح قابلة للتسوية من أشهر تقويمية مكتملة حتى نهاية الشهر الماضي",
    chartTitle: "نظرة عامة على التسوية",
    chartSubtitle: "اتجاهات التسوية الشهرية حسب الدراما",
    chartByTime: "حسب الوقت",
    chartByDrama: "حسب الدراما",
    chartAmount: "مبلغ التسوية",
    chartCumulative: "المُسوّى التراكمي",
    compareCourses: "مقارنة الدراما:",
    selectCourse: "اختيار",
    emptyChart: "لا توجد بيانات للرسم",
    recordsTitle: "سجلات التسوية",
    statusFilter: "الحالة",
    statusAll: "الكل",
    scopeAll: "كل الأنواع",
    searchPlaceholder: "ابحث برقم الطلب / الفترة",
    colOrderNo: "رقم الطلب",
    colPeriod: "الفترة",
    colType: "النوع",
    colRatio: "النسبة",
    colTypeRatio: "النوع / النسبة",
    colAccountNo: "رقم الحساب",
    colCreator: "المبلغ",
    colDate: "تاريخ التسوية",
    colStatus: "الحالة",
    colAction: "الإجراء",
    colOrders: "الطلبات",
    typeFull: "توزيع كامل",
    typeAccount: "صفحة الحساب",
    statusApplied: "بانتظار المراجعة",
    statusApproved: "بانتظار الصرف",
    statusPaid: "مدفوع",
    statusRejected: "مرفوض/فشل",
    groupApplied: "مقدَّم",
    groupSettled: "مُسوّى",
    groupFailed: "فشل",
    detail: "التفاصيل",
    detailTitle: "تفاصيل التسوية",
    detailOrderNo: "رقم الطلب",
    detailApplyTime: "قُدِّم في",
    detailPeriod: "الفترة",
    detailAccount: "حساب التحصيل",
    detailAmount: "المبلغ المطلوب",
    detailStatus: "حالة الطلب",
    detailGross: "الإجمالي",
    detailPlatform: "حصة المنصة",
    detailVoucher: "إيصال الدفع",
    itemCourse: "معرّف الدورة",
    itemGross: "الإجمالي",
    itemCreator: "صافي الناشر",
    applyConfirmTitle: "تقديم طلب التسوية؟",
    applyConfirmDesc: "سيُنشئ هذا أوامر تسوية لجميع الأشهر التقويمية المكتملة غير المسوّاة حتى نهاية الشهر الماضي.",
    applyConfirmPeriod: "الفترة",
    applyConfirmAmount: "المبلغ القابل للتسوية",
    applyConfirmAccount: "حساب التحصيل",
    applyConfirmTip: "تستغرق المراجعة 1-3 أيام عمل، مع الصرف قبل اليوم 15.",
    cancel: "إلغاء",
    confirmApply: "تقديم",
    rejectedReason: "سبب الفشل",
    emptyTitle: "لا توجد سجلات تسوية",
    emptyDesc: "لا توجد طلبات تسوية للعرض بعد.",
    applySuccess: "تم تقديم طلب التسوية",
  },
};
