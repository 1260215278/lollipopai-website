...
export const twoFactor: Record<Locale, TwoFactorMessages> = {
  ...
  es: {
    ...
    desc: "Se ha enviado un código de verificación a {phone}. Introduce el código SMS para terminar de iniciar sesión.",
    pendingDesc: "El código se está enviando. Puedes introducirlo en cuanto llegue.",
    codeLabel: "Código SMS",
    codePlaceholder: "Introduce el código",
    codeRequired: "Introduce el código",
    verify: "Verificar e iniciar sesión",
    resend: "Reenviar",
    resent: "Código reenviado",
    expireIn: "El código caduca en {s}s",
    expired: "El código ha caducado, reenvíalo",
    bindPhoneFirst: "La verificación en dos pasos está activada en esta cuenta y tu perfil de miembro no tiene teléfono vinculado. Contacta al administrador para desactivar la verificación o vincular tu teléfono primero.",
  },
  ar: {
    title: "التحقق بخطوتين",
    desc: "أُرسل رمز تحقق إلى {phone}. أدخل رمز الرسائل القصيرة لإكمال تسجيل الدخول.",
    pendingDesc: "جارٍ إرسال الرمز. يمكنك إدخاله فور وصوله.",
    codeLabel: "رمز الرسائل القصيرة",
    codePlaceholder: "أدخل الرمز",
    codeRequired: "أدخل الرمز",
    verify: "تحقق وسجّل الدخول",
    resend: "إعادة الإرسال",
    resent: "أُعيد إرسال الرمز",
    expireIn: "ينتهي الرمز خلال {s} ث",
    expired: "انتهت صلاحية الرمز، يرجى إعادة الإرسال",
    bindPhoneFirst: "التحقق بخطوتين مفعّل لهذا الحساب وملف العضو لا يحتوي على رقم هاتف. تواصل مع مسؤول الحساب لإيقاف التحقق بخطوتين أو ربط رقم هاتفك أولًا.",
  },
};
