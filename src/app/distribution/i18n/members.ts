 ...
 * zh-CN 为权威；zh-TW / en / pt / es / ar 结构一致。
 */
...
export const members: Record<Locale, MembersMessages> = {
  ...
  es: {
    ...
    bannerText:
      "Los administradores ya tienen derechos completos de visualización y gestión de todos los dramas de esta cuenta. El personal tiene visibilidad de dramas de forma predeterminada, por lo que no se necesita asignación manual aquí.",
    colMemberInfo: "Miembro",
    colAccountStatus: "Estado",
    colMemberType: "Rol",
    colAction: "Acción",
    phoneLine: "Teléfono: {phone}",
    selfTag: "(Yo)",
    remove: "Quitar",
    rolesSectionTitle: "Permisos por rol",
    roleOwner: "Propietario",
    roleAdmin: "Administrador",
    roleStaff: "Personal",
    roleDescriptions: {
      1: "Acceso completo a miembros, seguridad de la cuenta, dramas y liquidaciones.",
      2: "Puede ver y gestionar todos los dramas, pero no puede gestionar la seguridad de la cuenta ni los miembros.",
      3: "Puede crear y enviar nuevos dramas a revisión, y ver todos los dramas y datos básicos de forma predeterminada. No puede publicar ni retirar dramas.",
    },
    statusActive: "Activo",
    ...
    permissionLabels: {
      ...
      course: "Gestión de dramas",
      course_manage: "Gestión de dramas",
      COURSE_MANAGE: "Gestión de dramas",
      course_view_assigned: "Dramas asignados",
      COURSE_VIEW_ASSIGNED: "Dramas asignados",
      settlement_view: "Datos de liquidación",
      SETTLEMENT_VIEW: "Datos de liquidación",
      settlement_withdraw: "Retiros",
      SETTLEMENT_WITHDRAW: "Retiros",
      contract_view: "Ver contratos",
      CONTRACT_VIEW: "Ver contratos",
      contract_manage: "Gestión de contratos",
      CONTRACT_MANAGE: "Gestión de contratos",
      account_setting: "Ajustes de cuenta",
      ACCOUNT_SETTING: "Ajustes de cuenta",
      member_manage: "Gestión de miembros",
      MEMBER_MANAGE: "Gestión de miembros",
    },
    addModalTitle: "Añadir cuenta",
    memberTypeLabel: "Rol del miembro",
    phoneLabel: "Número de teléfono",
    phonePlaceholder: "Introduzca el número de teléfono",
    cancel: "Cancelar",
    confirm: "Confirmar",
    vPhoneInvalid: "Introduzca un número de teléfono",
    addSuccess: "Miembro añadido correctamente",
    removeModalTitle: "¿Quitar a este miembro?",
    removeModalDesc:
      "Tras quitarlo, este miembro dejará de pertenecer a esta cuenta y perderá el acceso a dramas, ingresos y demás datos. Esta acción no se puede deshacer. ¿Desea quitar a este miembro?",
  ...
  ar: {
    ...
    bannerText:
      "لدى المسؤولين بالفعل صلاحيات العرض والإدارة الكاملة لجميع أعمال الدراما في هذا الحساب. لدى الموظفين رؤية للدراما افتراضيًا، لذا لا حاجة للتعيين اليدوي هنا.",
    colMemberInfo: "العضو",
    colAccountStatus: "الحالة",
    colMemberType: "الدور",
    colAction: "الإجراء",
    phoneLine: "الهاتف: {phone}",
    selfTag: "(أنا)",
    remove: "إزالة",
    rolesSectionTitle: "صلاحيات الأدوار",
    roleOwner: "المالك",
    roleAdmin: "مسؤول",
    roleStaff: "موظف",
    roleDescriptions: {
      1: "وصول كامل إلى الأعضاء وأمان الحساب والدراما والتسويات.",
      2: "يمكنه عرض وإدارة جميع أعمال الدراما، لكن لا يمكنه إدارة أمان الحساب أو الأعضاء.",
      3: "يمكنه إنشاء أعمال دراما جديدة وإرسالها للمراجعة، وعرض جميع الأعمال والبيانات الأساسية افتراضيًا. لا يمكنه نشر الدراما أو إلغاء نشرها.",
    },
    statusActive: "نشط",
    statusInactive: "معطّل",
    permissionLabels: {
      dashboard: "لوحة البيانات",
      DASHBOARD_VIEW: "لوحة البيانات",
      course: "إدارة الدراما",
      course_manage: "إدارة الدراما",
      COURSE_MANAGE: "إدارة الدراما",
      course_view_assigned: "الدراما المعيّنة",
      COURSE_VIEW_ASSIGNED: "الدراما المعيّنة",
      settlement_view: "بيانات التسوية",
      SETTLEMENT_VIEW: "بيانات التسوية",
      settlement_withdraw: "السحب",
      SETTLEMENT_WITHDRAW: "السحب",
      contract_view: "عرض العقود",
      CONTRACT_VIEW: "عرض العقود",
      contract_manage: "إدارة العقود",
      CONTRACT_MANAGE: "إدارة العقود",
      account_setting: "إعدادات الحساب",
      ACCOUNT_SETTING: "إعدادات الحساب",
      member_manage: "إدارة الأعضاء",
      MEMBER_MANAGE: "إدارة الأعضاء",
    },
    addModalTitle: "إضافة حساب",
    memberTypeLabel: "دور العضو",
    phoneLabel: "رقم الهاتف",
    phonePlaceholder: "أدخل رقم الهاتف",
    cancel: "إلغاء",
    confirm: "تأكيد",
    vPhoneInvalid: "يرجى إدخال رقم هاتف",
    addSuccess: "تمت إضافة العضو بنجاح",
    removeModalTitle: "إزالة هذا العضو؟",
    removeModalDesc:
      "بعد الإزالة لن ينتمي هذا العضو إلى هذا الحساب وسيفقد الوصول إلى الدراما والأرباح والبيانات الأخرى. لا يمكن التراجع عن هذا الإجراء. هل تريد إزالة هذا العضو؟",
    removeConfirm: "تأكيد الإزالة",
