 ...
 * en 同步；zh-TW / pt / es / ar 机翻占位，结构一致。
...
export const enroll: Record<Locale, EnrollMessages> = {
  ...
  es: {
    bannerTitle: "Bienvenido a Lollipop",
    bannerSubtitle: "La primera plataforma de creación de video con IA del mundo",
    welcomeTitle: "Complete los datos a continuación para distribuir dramas en Lollipop",
    welcomeSubtitle: "Tras el alta, podrá publicar contenido, participar en la distribución de ingresos y llegar a más espectadores.",
    sectionAccount: "Cuenta vinculada",
    sectionCompany: "Información de la empresa",
    sectionAgreement: "Acuerdo de cooperación",
    accountModePhone: "Teléfono",
    accountModeEmail: "Correo",
    phoneLabel: "Número de teléfono",
    phonePlaceholder: "Introduzca su número de teléfono",
    phoneBoundHint: "Vinculado al teléfono de su cuenta; no es necesario cambiarlo",
    phoneRegisterHint: "Este número se registrará como su cuenta Lollipop y también podrá iniciar sesión en la herramienta de video con IA Swift",
    emailLabel: "Correo",
    emailPlaceholder: "Introduzca su dirección de correo",
    emailBoundHint: "Vinculado al correo de su cuenta; no es necesario cambiarlo",
    emailRegisterHint: "Este correo se registrará como su cuenta Lollipop. El alta por correo aún no aprovisiona automáticamente un tenant de Swift; reintente cuando Swift admita inicio de sesión por correo.",
    ...
    businessLicenseLabel: "Licencia comercial",
    legalPersonNameLabel: "Nombre del representante legal",
    legalPersonNamePlaceholder: "Introduzca el nombre del representante legal",
    legalPersonIdNoLabel: "Número de identidad del representante legal",
    legalPersonIdNoPlaceholder: "Introduzca el número de identidad de 18 dígitos",
    idCardFrontLabel: "Documento de identidad (anverso)",
    idCardBackLabel: "Documento de identidad (reverso)",
    uploadPrompt: "Haga clic o arrastre para subir",
    uploadFormat: "Admite JPG, PNG, HEIC",
    uploadReplace: "Haga clic para reemplazar",
    uploadFailed: "Error al subir, inténtelo de nuevo",
    agreement: "He leído y acepto el {terms} y la {privacy}",
    agreementTerms: "Acuerdo de alta en la plataforma",
    agreementPrivacy: "Política de privacidad",
    termsTitle: "Acuerdo de alta en la plataforma",
    privacyTitle: "Política de privacidad",
    // TODO(verify): texto provisional, sustituir por el Acuerdo de alta en la plataforma oficial
    termsBody: "[Texto del acuerdo pendiente] Inserte aquí el Acuerdo de alta en la plataforma oficial.",
    // TODO(verify): texto provisional, sustituir por la Política de privacidad oficial
    privacyBody: "[Texto de la política pendiente] Inserte aquí la Política de privacidad oficial.",
    docClose: "Cerrar",
    submit: "Enviar solicitud",
    resubmit: "Editar y reenviar",
    vPhoneRequired: "Introduzca su número de teléfono",
    vEmailRequired: "Introduzca su correo",
    vCodeRequired: "Introduzca el código de verificación",
    vCompanyRequired: "Introduzca el nombre de la empresa",
    vLicenseRequired: "Suba la licencia comercial",
    vLegalNameRequired: "Introduzca el nombre del representante legal",
    vLegalIdRequired: "Introduzca el número de identidad del representante legal",
    vIdFrontRequired: "Suba el anverso del documento de identidad",
    vIdBackRequired: "Suba el reverso del documento de identidad",
    vAgreementRequired: "Acepte primero el acuerdo de cooperación y la política de privacidad",
    sendCodeSuccess: "Código de verificación enviado",
    submitSuccess: "Enviado correctamente, pasando a revisión",
    reviewingTitle: "En revisión",
    reviewingDesc: "Su solicitud ha sido enviada. Completaremos la revisión en 3-5 días hábiles. Esté atento a las notificaciones por SMS.",
    reviewingInProgress: "En curso",
    step1Title: "Solicitud enviada",
    step1Sub: "Documentos recibidos",
    step2Title: "En revisión",
    step2Sub: "Est. 3-5 días hábiles",
    step3Title: "Notificación del resultado",
    step3Sub: "Notificación en línea manual",
    step4Title: "Alta completada",
    step4Sub: "Cuenta de la plataforma activada",
    approvedTitle: "Aprobado",
    approvedDesc: "Felicitaciones, la solicitud de {company} ha sido aprobada. ¡Bienvenido a Lollipop!",
    swiftAccountStatus: "Estado de la cuenta Swift",
    swiftOpening: "La cuenta Swift se está aprovisionando. Vuelva a consultar más tarde.",
    swiftReady: "La cuenta Swift está lista.",
    swiftAccount: "Cuenta de inicio de sesión",
    swiftInitialPassword: "Contraseña inicial",
    swiftTenantId: "Código de invitación del equipo",
    swiftLastSync: "Última sincronización",
    swiftRetry: "Reintentar",
    swiftRetrySuccess: "Reintento iniciado. Vuelva a consultar más tarde.",
    enterDashboard: "Entrar al centro de distribución",
    rejectedTitle: "No aprobado",
    rejectedDesc: "Lamentablemente, su solicitud no fue aprobada. Revise y reenvíe.",
    rejectReasonLabel: "Motivo del rechazo",
    commonReasonsLabel: "Motivos comunes",
    commonReasons: [
      "La imagen de la licencia comercial está borrosa o incompleta",
      "El anverso/reverso del documento de identidad se subió de forma incorrecta o no está nítido",
      "El código unificado de crédito social no coincide con la licencia comercial",
      "La información de la empresa no coincide con el registro mercantil",
    ],
    supportPrefix: "¿Dudas? Contacte",
    supportEmail: "support@lollipop.com",
  },
  ar: {
    bannerTitle: "مرحبًا بك في Lollipop",
    bannerSubtitle: "أول منصة في العالم لإنشاء الفيديو بالذكاء الاصطناعي",
    welcomeTitle: "أكمل البيانات أدناه لتوزيع الدراما على Lollipop",
    welcomeSubtitle: "بعد إتمام التسجيل يمكنك نشر المحتوى والمشاركة في تقسيم الإيرادات والوصول إلى مزيد من المشاهدين.",
    sectionAccount: "الحساب المرتبط",
    sectionCompany: "معلومات الشركة",
    sectionAgreement: "اتفاقية التعاون",
    accountModePhone: "الهاتف",
    accountModeEmail: "البريد الإلكتروني",
    phoneLabel: "رقم الهاتف",
    phonePlaceholder: "أدخل رقم هاتفك",
    phoneBoundHint: "مرتبط برقم هاتف حسابك؛ لا حاجة للتغيير",
    phoneRegisterHint: "سيُسجَّل هذا الرقم كحساب Lollipop ويمكنه أيضًا تسجيل الدخول إلى أداة الفيديو بالذكاء الاصطناعي Swift",
    emailLabel: "البريد الإلكتروني",
    emailPlaceholder: "أدخل عنوان بريدك الإلكتروني",
    emailBoundHint: "مرتبط ببريد حسابك؛ لا حاجة للتغيير",
    emailRegisterHint: "سيُسجَّل هذا البريد كحساب Lollipop. التسجيل بالبريد لا يُنشئ تلقائيًا مستأجر Swift بعد؛ أعد المحاولة عندما يدعم Swift تسجيل الدخول بالبريد.",
    ...
    businessLicenseLabel: "الرخصة التجارية",
    legalPersonNameLabel: "اسم الممثل القانوني",
    legalPersonNamePlaceholder: "أدخل اسم الممثل القانوني",
    legalPersonIdNoLabel: "رقم هوية الممثل القانوني",
    legalPersonIdNoPlaceholder: "أدخل رقم الهوية المكوّن من 18 رقمًا",
    idCardFrontLabel: "بطاقة الهوية (جهة الصورة)",
    idCardBackLabel: "بطاقة الهوية (جهة الشعار)",
    uploadPrompt: "انقر أو اسحب للرفع",
    uploadFormat: "يدعم JPG و PNG و HEIC",
    uploadReplace: "انقر للاستبدال",
    uploadFailed: "فشل الرفع، يرجى المحاولة مرة أخرى",
    agreement: "لقد قرأت وأوافق على {terms} و{privacy}",
    agreementTerms: "اتفاقية الانضمام إلى المنصة",
    agreementPrivacy: "سياسة الخصوصية",
    termsTitle: "اتفاقية الانضمام إلى المنصة",
    privacyTitle: "سياسة الخصوصية",
    // TODO(verify): نص مؤقت، يُستبدل بنص اتفاقية الانضمام الرسمية
    termsBody: "[نص الاتفاقية معلّق] يرجى إدراج اتفاقية الانضمام الرسمية إلى المنصة هنا.",
    // TODO(verify): نص مؤقت، يُستبدل بنص سياسة الخصوصية الرسمية
    privacyBody: "[نص سياسة الخصوصية معلّق] يرجى إدراج سياسة الخصوصية الرسمية هنا.",
    docClose: "إغلاق",
    submit: "تقديم الطلب",
    resubmit: "تعديل وإعادة التقديم",
    vPhoneRequired: "يرجى إدخال رقم هاتفك",
    vEmailRequired: "يرجى إدخال بريدك الإلكتروني",
    vCodeRequired: "يرجى إدخال رمز التحقق",
    vCompanyRequired: "يرجى إدخال اسم الشركة",
    vLicenseRequired: "يرجى رفع الرخصة التجارية",
    vLegalNameRequired: "يرجى إدخال اسم الممثل القانوني",
    vLegalIdRequired: "يرجى إدخال رقم هوية الممثل القانوني",
    vIdFrontRequired: "يرجى رفع جهة الصورة من بطاقة الهوية",
    vIdBackRequired: "يرجى رفع جهة الشعار من بطاقة الهوية",
    vAgreementRequired: "يرجى الموافقة أولًا على اتفاقية التعاون وسياسة الخصوصية",
    sendCodeSuccess: "تم إرسال رمز التحقق",
    submitSuccess: "تم التقديم بنجاح، وجارٍ الدخول في المراجعة",
    reviewingTitle: "قيد المراجعة",
    reviewingDesc: "تم تقديم طلبك. سنكمل المراجعة خلال 3-5 أيام عمل. يرجى متابعة إشعارات الرسائل النصية.",
    reviewingInProgress: "جارٍ التنفيذ",
    step1Title: "تم تقديم الطلب",
    step1Sub: "تم استلام المستندات",
    step2Title: "قيد المراجعة",
    step2Sub: "تقدير 3-5 أيام عمل",
    step3Title: "إشعار النتيجة",
    step3Sub: "إشعار يدوي عبر الإنترنت",
    step4Title: "اكتمل التسجيل",
    step4Sub: "تم تفعيل حساب المنصة",
    approvedTitle: "تمت الموافقة",
    approvedDesc: "تهانينا، تمت الموافقة على طلب {company}. مرحبًا بك في Lollipop!",
    swiftAccountStatus: "حالة حساب Swift",
    swiftOpening: "جارٍ تجهيز حساب Swift. يرجى التحقق لاحقًا.",
    swiftReady: "حساب Swift جاهز.",
    swiftAccount: "حساب تسجيل الدخول",
    swiftInitialPassword: "كلمة المرور الأولية",
    swiftTenantId: "رمز دعوة الفريق",
    swiftLastSync: "وقت آخر مزامنة",
    swiftRetry: "إعادة المحاولة",
    swiftRetrySuccess: "تم تشغيل إعادة المحاولة. يرجى التحقق لاحقًا.",
    enterDashboard: "دخول مركز التوزيع",
    rejectedTitle: "غير موافق عليه",
    rejectedDesc: "للأسف لم تتم الموافقة على طلبك. يرجى المراجعة وإعادة التقديم.",
    rejectReasonLabel: "سبب الرفض",
    commonReasonsLabel: "أسباب شائعة",
    commonReasons: [
      "صورة الرخصة التجارية غير واضحة أو غير مكتملة",
      "تم رفع وجهَي بطاقة الهوية بشكل خاطئ أو غير واضح",
      "رمز الائتمان الاجتماعي الموحد لا يطابق الرخصة التجارية",
      "معلومات الشركة لا تطابق السجل التجاري",
    ],
    supportPrefix: "أسئلة؟ تواصل مع",
    supportEmail: "support@lollipop.com",
  },
};
